...
class encoder_decoder(nn.Module):
    def __init__(self, input_dim, num_heads=2, num_layers=1, n_channels=64, n_seq=3):
        ...
        # Encoder: Conv1D and Pooling layers with activations and batch norm
        ...
        # Decoder: Designed as the inverse of the encoder with activations and batch norm
        ...
        # Final decoder layer without activation (output layer)
